...
const nav = [
  ...
  { to: "/revision", label: "Revisions", icon: RotateCcw },
      ...
      <aside className="hidden md:flex w-60 shrink-0 flex-col border-r border-border/60 bg-sidebar/60 backdrop-blur-xl sticky top-0 h-screen">
        ...
        <div className="p-3 border-t border-border/60 space-y-2">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 rounded-lg bg-primary text-primary-foreground px-3 py-2 text-sm font-medium hover:opacity-90 transition"
          >
