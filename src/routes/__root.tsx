...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "JEE OS — Your personal preparation operating system" },
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="en" className="dark">
      ...
      <body className="bg-background text-foreground antialiased" style={{ fontFamily: "Inter, ui-sans-serif, system-ui, sans-serif" }}>
        {children}
        <Scripts />
      </body>
    </html>
